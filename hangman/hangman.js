...
var hangman = {
  ...
  newGame: function() {
    if(this.guessesRemaining === 10) {
      console.log("AlRight! Let us get started!");
      console.log('*****************************');
    ...
    inquirer.prompt([{
      ...
      var guessedAlready = false;
        ...
        if(guessedAlready === false){
          ...
          if(found === 0){
            console.log('No! Your guess is wrong.');
            that.guessesRemaining--;
            that.display++;
            console.log('Number of Guesses remaining: ' + that.guessesRemaining);
            ...
            console.log("Letters you guessed: " + that.guessedLetters);
          } else{
          ...
          if(that.guessesRemaining > 0 && that.currentWord.wordFound === false) {
            ...
            console.log("You guessed that letter already. Try a different letter.");
            that.keepPromptingUser();
          }
    });
  }
